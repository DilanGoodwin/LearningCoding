...
namespace ChallengeBank{ 
    class Program{ 
        static void Main(string[] args){ 
            ...
            //Each account set common & specific operations/features
            //Define methods deposit, withdrawal, Inquire Balance, Account Owner
            // Savings account interest rate, applyinterest 
            //Rules & restrictions
